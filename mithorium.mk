...
PRODUCT_COPY_FILES += \
    ...
    $(OUT_DIR)/target/product/$(PRODUCT_RELEASE_NAME)/system/lib64/libpuresoftkeymasterdevice.so:$(TARGET_COPY_OUT_RECOVERY)/root/system/lib64/libpuresoftkeymasterdevice.so \
